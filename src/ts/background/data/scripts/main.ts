        ...
        err(() => {
            this.defaults = {
                ...
                close_other_tabs: {
                    ...
                    action_position: 0,
                    action_type: 'close',
                    which_windows_to_perform_action_on: 'current_window',
                    which_tabs_to_perform_action_on: 'other_tabs',
                    pinned_tabs: 'only_on_unpinned',
                    grouped_tabs: 'any',
                    domains: 'any_domain',
                    domain_whitelist: [],
                    domain_blacklist: [],
                ...
                close_tabs_to_the_right: {
                    ...
                    action_type: 'close',
                    which_windows_to_perform_action_on: 'current_window',
                    which_tabs_to_perform_action_on: 'tabs_to_right',
                    pinned_tabs: 'only_on_unpinned',
                    grouped_tabs: 'any',
                    domains: 'any_domain',
                    domain_whitelist: [],
                ...
                close_tabs_to_the_left: {
                    ...
                    action_type: 'close',
                    which_windows_to_perform_action_on: 'current_window',
                    which_tabs_to_perform_action_on: 'tabs_to_left',
                    pinned_tabs: 'only_on_unpinned',
                    grouped_tabs: 'any',
                    domains: 'any_domain',
                    domain_whitelist: [],
